  ...
  for (const category of CATEGORIES) {
    ...
    try {
      ...
      const completion = await openai.chat.completions.create({
        ...
        messages: [{
          role: "system",
          content: `You are a linguistic expert creating a Portuguese learning dataset. 
          Return a JSON object with a key "sentences" containing 15 entries.
          Each entry must have:
          - "original": The Portuguese phrase. make sure this is pure Portuguese without any English words.
          ...
          - "breakdown": A Map/Object where keys are Portuguese words and values are English meanings.
      ...
      for (const item of sentences) {
        ...
        const mp3 = await openai.audio.speech.create({
          ...
          voice: "nova",
          instructions: "Speak naturally in Portuguese.",
          input: item.original,
        });
